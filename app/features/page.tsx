...
import { Brain, Sparkles, Lock, Timer, BarChart3, Video } from 'lucide-react'

export default function FeaturesPage() {
  const features = [
    { icon: Brain, title: 'تحليل ذكي', desc: 'خوارزميات متقدمة لتحليل إجاباتك بدقة عالية.', color: 'text-blue-500' },
