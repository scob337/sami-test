        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="relative bg-background rounded-3xl p-8 border border-border flex items-center justify-center ltr-parent" dir="ltr">
                    ...
                    <div className="relative w-full max-w-sm bg-white border border-border shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1)] rounded-xl p-6 border-t-8 border-t-accent" dir="rtl">
                        ...
                        <div className="space-y-3">
                            <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-3 flex gap-3 items-start">
                                <ThumbsUp className="text-emerald-600 mt-0.5 shrink-0 w-4 h-4" />
                                <div>
                                    <span className="block text-xs font-bold text-emerald-800 uppercase tracking-widest mb-1">يُنصح به</span>
                                    <p className="text-xs text-emerald-700 font-bold">ركز على الأهداف المستقبلية واستخدم لغة منطقية وواضحة ترتكز على البيانات.</p>
                                </div>
                            </div>
                            <div className="bg-red-50 border border-red-100 rounded-xl p-3 flex gap-3 items-start">
                                <ThumbsDown className="text-red-600 mt-0.5 shrink-0 w-4 h-4" />
                                <div>
                                    <span className="block text-xs font-bold text-red-800 uppercase tracking-widest mb-1">تجنب</span>
                                    <p className="text-xs text-red-700 font-bold">إغراقهم بالتفاصيل الصغيرة غير الضرورية أو اتخاذ قرارات متسرعة بدون أسس موضوعية.</p>
                                </div>
                            </div>
                        </div>
                    </div>
