...
export default function DashboardPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col bg-[#f8f9fa] text-slate-800" dir="rtl">
      <Header />

      {/* Top Banner Area */}
      <div className="bg-white border-b border-gray-200 mt-16 pt-10 pb-12 w-full">
        <Container>
          <div className="max-w-6xl mx-auto space-y-8 px-4 sm:px-6 lg:px-8">
             <div className="space-y-2">
               ...
               <p className="text-slate-600 text-lg">
                 إليك ما يمكنك القيام به اليوم في منصة MindMatch
               </p>
             </div>
      ...
      <div className="flex-1 py-12">
        <Container>
          <div className="max-w-6xl mx-auto space-y-6 px-4 sm:px-6 lg:px-8">
            <h2 className="text-sm font-bold text-slate-500 tracking-wider">البدء</h2>
            
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              
              {/* Main Card (Profile/Test) */}
              <Card className="lg:col-span-2 p-8 sm:p-12 border border-gray-200 shadow-sm rounded-xl bg-white flex flex-col items-center text-center space-y-8">
                 ...
                 <div className="w-48 h-48 sm:w-64 sm:h-64 rounded-full bg-gradient-to-tr from-rose-100 via-amber-50 to-teal-100 border-8 border-white shadow-lg flex items-center justify-center relative spin-slow relative overflow-hidden">
                    <div className="absolute inset-0 flex items-center justify-center">
                       {/* Wheel segments mockup */}
                       <div className="w-full h-px bg-white/50 absolute rotate-45 transform origin-center"></div>
                       <div className="w-full h-px bg-white/50 absolute -rotate-45 transform origin-center"></div>
                       <div className="w-full h-px bg-white/50 absolute rotate-90 transform origin-center"></div>
                       <div className="w-full h-px bg-white/50 absolute transform origin-center"></div>
                    </div>
                    <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-[#f8f9fa] shadow-inner z-10 border border-gray-100"></div>
                 </div>
                 
                 <div className="space-y-4 max-w-lg mt-4">
                   <h3 className="text-2xl font-bold text-slate-900">خذ اختبار الشخصية الخاص بك!</h3>
              ...
              <div className="lg:col-span-1 flex flex-col gap-6">
                 ...
                 {/* Library Card */}
                 <Card className="p-6 border border-gray-200 shadow-sm rounded-xl bg-white flex flex-col space-y-6">
                    <div className="flex items-center gap-3 font-bold text-slate-800">
                      <Download className="w-5 h-5 text-slate-900" /> مكتبة المنصة
                    </div>
                    <div className="flex flex-col items-center justify-center py-6 bg-slate-50 border border-gray-100 rounded-lg">
                      <BookOpen className="w-10 h-10 text-slate-400 mb-2" />
                      <div className="text-center">
                        <span className="text-sm text-slate-500 font-medium">متوفر في</span><br/>
                        <span className="text-lg font-bold text-slate-700">المتجر الرقمي</span>
                      </div>
                    </div>
                    <p className="text-sm text-center text-slate-600 px-2 leading-relaxed">
                 ...
                 <Card className="p-6 border border-gray-200 shadow-sm rounded-xl bg-white flex flex-col space-y-6">
                    <div className="flex items-center gap-3 font-bold text-slate-800">
                      <Calendar className="w-5 h-5 text-slate-900" /> اختباراتك السابقة
                    </div>
                    <div className="flex justify-center gap-6 py-6 border-b border-gray-100">
                    ...
                    <Button variant="outline" className="w-full border-gray-300 text-slate-600 hover:bg-slate-50 hover:text-slate-900 py-6 h-auto font-semibold">
                       عرض النتائج
                    </Button>
                 </Card>
      ...
      <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
        <DialogContent className="max-w-2xl bg-white border-0 shadow-2xl rounded-xl" dir="rtl">
          <DialogHeader>
          ...
          <div className="space-y-6 py-6">
            <div className="space-y-3">
              ...
              <Input
                ...
                className="text-right h-12 px-4 rounded-md bg-white border-gray-300 focus:border-[#2ba8e0] font-medium"
              />
            </div>
          ...
          <DialogFooter className="flex flex-col sm:flex-row-reverse gap-3 pt-4 border-t border-gray-100">
            <Button
            ...
            <Button 
              ...
              className="w-full sm:w-auto h-12 px-6 rounded-md text-slate-600 border-gray-300 font-bold hover:bg-slate-50"
            >
              إلغاء
            </Button>
          </DialogFooter>
