...
export function FeaturesSection() {
  return (
    <>
        ...
        <section className="py-24 overflow-hidden bg-background border-y border-border" dir="rtl">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="order-2 lg:order-1 relative bg-white rounded-3xl p-8 border border-border flex items-center justify-center shadow-sm" dir="ltr">
                        ...
                        <div className="relative w-full max-w-md bg-white border border-border shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1)] rounded-xl overflow-hidden flex flex-col">
                            {/* Editor Header */}
                            ...
                            <div className="p-4 flex-1 space-y-4 text-left">
                                <div className="flex items-center gap-2 border-b border-border pb-2">
                                    ...
                                    <span className="text-sm font-bold text-primary bg-muted px-2 py-0.5 rounded">ali@mindmatch.app</span>
                                </div>
                                <div className="flex items-center gap-2 border-b border-border pb-2">
                                ...
                                <div className="pt-2 text-right">
                                    ...
                                    <div className="flex items-center gap-2 mb-3 justify-end">
                                        <span className="text-xs font-bold text-primary">الذكاء الاصطناعي يقوم بصياغة تقرير بناءً على نمط (ESTJ)...</span>
                                        <Wand2 className="w-4 h-4 text-accent" />
                                    </div>
                                    <p className="text-sm font-bold text-primary leading-relaxed bg-[#F3F6FA] p-4 rounded-xl border border-[#E1E5EA]" dir="rtl">
                                        مرحباً علي، <br/><br/>
        ...
        <section className="py-24 bg-white" dir="rtl">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* Card 1 */}
                    <div className="bg-white border text-primary border-border rounded-xl p-8 hover:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1)] hover:-translate-y-1 transition-all duration-300 group">
        ...
        {/* CTA Section */}
        <section className="py-24 bg-primary text-white relative overflow-hidden" dir="rtl">
            <div className="absolute inset-0 opacity-10 bg-[radial-gradient(#ffffff_1px,transparent_1px)] [background-size:20px_20px]"></div>
            
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                <h2 className="text-3xl sm:text-5xl font-bold tracking-tight mb-6 leading-tight">هل أنت مستعد لفهم نفسك بشكل أفضل؟</h2>
